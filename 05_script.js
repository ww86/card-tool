...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function populateFontSelectors(availableFonts, fontSelectorConfigs) {
    ...
    // testAvailableFonts(availableFonts), function which tests all the fonts, 
    // and does showOnLoadError incase of problem

    function testAvailableFonts(fonts) {
    ...
    document.fonts.ready.then(() => {
      testAvailableFonts(availableFonts);
    });
  ...
  function importJSONFile(file) {
      ...
      reader.onload = function (event) {
          try {
              ...
              if (template.mainSrc) {
                  global.art.mainSrc = wrapImgPath(template.mainSrc);
